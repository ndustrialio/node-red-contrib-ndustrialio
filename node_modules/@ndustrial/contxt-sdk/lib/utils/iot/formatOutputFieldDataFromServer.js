...
function formatOutputFieldDataFromServer() {
  ...
  var meta = input.meta || {};
  var query = (0, _index.parseOutputFieldNextPageUrlMetadata)(meta.next_page_url);
  var records = input.records || [];

  return {
    meta: _extends({}, (0, _objects.toCamelCase)(input.meta, { excludeKeys: ['next_page_url'] }), query),
    records: (0, _objects.toCamelCase)(records)
  };
}

exports.default = formatOutputFieldDataFromServer;
//# sourceMappingURL=formatOutputFieldDataFromServer.js.map
