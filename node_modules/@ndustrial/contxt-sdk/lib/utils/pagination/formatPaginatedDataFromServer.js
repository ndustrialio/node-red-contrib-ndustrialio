...
function defaultFormatter(value) {
  return (0, _objects.toCamelCase)(value);
}
...
function formatPaginatedDataFromServer() {
  ...
  var recordFormatter = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : defaultFormatter;

  var _metadata = input._metadata || {};
  var records = input.records || [];

  return {
    _metadata: (0, _objects.toCamelCase)(_metadata),
    records: records.map(recordFormatter)
  };
}

exports.default = formatPaginatedDataFromServer;
//# sourceMappingURL=formatPaginatedDataFromServer.js.map
