...
var Events = function () {
  ...
  _createClass(Events, [{
    ...
    value: function create() {
      ...
      return this._request.post(this._baseUrl + '/events', (0, _objects.toSnakeCase)(event)).then(function (response) {
    ...
    value: function get(eventId) {
      ...
      return this._request.get(this._baseUrl + '/events/' + eventId).then(function (event) {
        return (0, _objects.toCamelCase)(event);
      });
    }
    ...
    value: function getEventsByTypeId(eventTypeId) {
      ...
      return this._request.get(this._baseUrl + '/types/' + eventTypeId + '/events', {
        params: (0, _objects.toSnakeCase)(eventFilters)
      }).then(function (events) {
        return (0, _pagination.formatPaginatedDataFromServer)(events);
      });
    }
    ...
    value: function update(eventId, _update) {
      ...
      var formattedUpdate = (0, _events.formatEventUpdateToServer)(_update);
    ...
    value: function createEventType() {
      ...
      for (var i = 0; i < requiredFields.length; i++) {
        ...
        if (!(0, _lodash2.default)(eventType, field)) {
          return Promise.reject(new Error('A ' + field + ' is required to create a new event type.'));
        }
      }

      return this._request.post(this._baseUrl + '/types', (0, _objects.toSnakeCase)(eventType)).then(function (response) {
        return (0, _objects.toCamelCase)(response);
      });
    }
  }]);
