...
var Users = function () {
  ...
  _createClass(Users, [{
    ...
    value: function activate(userId) {
      ...
      return _axios2.default.post(this._baseUrl + '/users/' + userId + '/activate', (0, _objects.toSnakeCase)(user));
    }
    ...
    value: function addRole(userId, roleId) {
      ...
      return this._request.post(this._baseUrl + '/users/' + userId + '/roles/' + roleId).then(function (response) {
        return (0, _objects.toCamelCase)(response);
      });
    }
    ...
    value: function getByOrganizationId(organizationId) {
      if (this._organizationId) {
        return this._request.get(this._baseUrl + '/users').then(function (orgUsers) {
    ...
    value: function invite(organizationId) {
      ...
      if (this._organizationId) {
        ...
        return this._request.post(this._baseUrl + '/users', (0, _objects.toSnakeCase)(user)).then(function (response) {
          return (0, _objects.toCamelCase)(response);
        });
      }
    ...
    value: function removeRole(userId, roleId) {
      ...
      return this._request.delete(this._baseUrl + '/users/' + userId + '/roles/' + roleId);
    }
