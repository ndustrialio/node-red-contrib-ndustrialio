  ...
  _createClass(Roles, [{
    ...
    value: function create(organizationId) {
      ...
      if (this._organizationId) {
        ...
        return this._request.post(this._baseUrl + '/roles', toSnakeCase(role)).then(function (response) {
          return toCamelCase(response);
        });
      }
      ...
      return this._request.post(this._baseUrl + '/organizations/' + organizationId + '/roles', toSnakeCase(role)).then(function (response) {
        return toCamelCase(response);
      });
    }
