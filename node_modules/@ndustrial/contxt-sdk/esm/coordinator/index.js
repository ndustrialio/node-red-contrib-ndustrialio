...
var Coordinator = function () {
  ...
  _createClass(Coordinator, [{
    ...
    value: function setOrganizationId(organizationId) {
      ...
      this.applications = new Applications(this._sdk, this._request, this._deployBaseUrl || this._baseUrl, this._organizationId);
      this.consent = new Consent(this._sdk, this._request, this._deployBaseUrl || this._baseUrl, this._organizationId);
      this.edgeNodes = new EdgeNodes(this._sdk, this._request, this._deployBaseUrl || this._baseUrl, this._organizationId);
